...
public class ImageServiceImpl implements ImageService {
     ...
     */
    @Override
    public List<String> find(Long targetId, ImageType type) {
        return imageRepository.findByTargetIdAndTypeElseThrow(targetId, type).stream().map(Image::getImgUrl).toList();
    }
